   ...
   // private DigitalChannel digitalTouch = null;
    ...
    public void runOpMode() {
       ...
       // digitalTouch.setMode(DigitalChannel.Mode.INPUT);
        ...
        final int CAMERA_FORWARD_DISPLACEMENT = 30;   // eg: Camera is 30 mm in front of robot center
        final int CAMERA_VERTICAL_DISPLACEMENT = 130;   // eg: Camera is 130 mm above ground
        final int CAMERA_LEFT_DISPLACEMENT = -50;     // eg: Camera is 50 mm to the right of robot center
        // adjust
                ...
                switch (trackable.getName()) {
                    ...
                    case "blueRover":
                        switch (startQuadrant) {
                            case "blueDepot":
                                ...
                                encoderDrive(DRIVE_SPEED, Math.abs(blueCraterDisX), Math.abs(blueCraterDisX), 20);
                                gyroTurnTo(TURN_SPEED, 0);
                                encoderDrive(DRIVE_SPEED, blueCraterDisY, blueCraterDisY, 20);
                                break;
                            case "blueCrater":
                                gyroTurnTo(TURN_SPEED, -135);
                                encoderDrive(DRIVE_SPEED, 177.8, 177.8, 20);
                                break;
                            default:
                    ...
                    case "redFootprint":
                        switch (startQuadrant) {
                            case "redDepot":
                                gyroTurnTo(TURN_SPEED, -90);
                                encoderDrive(DRIVE_SPEED, Math.abs(redCraterDisX), Math.abs(redCraterDisX), 20);
                                gyroTurnTo(TURN_SPEED, -179.999999);
                                encoderDrive(DRIVE_SPEED, Math.abs(redCraterDisY), Math.abs(redCraterDisY), 20);
                                break;
                            case "redCrater":
                                gyroTurnTo(TURN_SPEED, -135);
                                encoderDrive(DRIVE_SPEED, 177.8, 177.8, 20);
                    ...
                    case "backSpace":
                        switch (startQuadrant) {
                            case "blueDepot":
                                ...
                                encoderDrive(DRIVE_SPEED, Math.abs(blueCraterDisX), Math.abs(blueCraterDisX), 20);
                                gyroTurnTo(TURN_SPEED, 0);
                                encoderDrive(DRIVE_SPEED, Math.abs(blueCraterDisY), Math.abs(blueCraterDisY), 20);
                                break;
                            case "redCrater":
                                gyroTurnTo(TURN_SPEED, -135);
                                encoderDrive(DRIVE_SPEED, 177.8, 177.8, 20);
